...
public class ReservationFrame extends javax.swing.JFrame {
    ...
    String sql_screen = 
        ...
        "SELECT r.StartTime, r.EndTime, r.Movie_Name, r.Movie_Count, r.Room_No, r.Total_Seat, r.Time_ID, r.Theater_Name, r.Seat_Row, r.seat_Col, r.Movie_Date, r.Movie_Poster\n" +
    ...
    public ReservationFrame(DBManager dbManager, String user_id) {
        ...
        JButton calender = new JButton("달력");
        ...
        @Override
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                for (String[] m : movie){
                    if (m[0].equals(MovieList.getSelectedValue())){
                        Movie_id = Integer.parseInt(m[3]);
                    }
                }
        ...
        @Override
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                TheaterTable(RegionList.getSelectedValue());
                System.out.println(RegionList.getSelectedValue());
            }
        });
        ...
        @Override
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                for (String[] t : theater){
                    if (t[0].equals(RegionList.getSelectedValue()) && t[1].equals(TheaterList.getSelectedValue())){
                        Theater_id = Integer.parseInt(t[2]);
                        break;
                    }
                }
        ...
        @Override
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                // 다음 프레임으로 값 전송
                new SeatFrame(ScreenTime.get(idx), dbManager, user_id).setVisible(true);
                dispose();
            }
        });
        ...
        calender.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                new CalendarMain(dbManager, user_id).setVisible(true);
                dispose();
            }
        });
        // 날짜 변경
    ...
    // 홈으로
    private void homePerformed(ActionEvent e){
        new HomeFrame(dbManager, user_id).setVisible(true);
        dispose();
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReservationFrame(DBManagerMySql.getinstance()).setVisible(true);
            }
        });
        */
    }
